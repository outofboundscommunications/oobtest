								...
								<div class="subscriber-fron">
									<form class="news_latter_form" id="footer-newsletter">
										<div class="form-group input-group-x divcenter">									
											<input type="email" value="" class="form-control news_letter_email wow fadeInLeft" name="name" placeholder="Enter your Email" data-wow-duration="1s"/>
...
jQuery(document).ready(function(){
    ...
    jQuery("#category-menu a").removeClass("hover");
