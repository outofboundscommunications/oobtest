	...
	<header id="masthead" class="site-header" role="banner">
		<div id="branding-top" class="header">
			<div class="container-fluid">
				<div class="row">
					<div class="branding-top-left col-xs-4 col-sm-2 col-md-2 col-lg-2 wow fadeInLeft" data-wow-duration="1s">
						<hgroup>
							<?php
					...
					<div class="branding-top-right col-sm-10 col-xs-8 text-right wow fadeInRight" data-wow-duration="1s">
						<?php
						wp_nav_menu( array(
