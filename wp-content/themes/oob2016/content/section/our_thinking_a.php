...
if ( $the_query->have_posts() ) {
	...
	<div class="row">
		...
		while ( $the_query->have_posts() ) {
			...
			// Icon
			$thumb_url = get_stylesheet_directory_uri().'/images/search-marketing-icon.png';
			$thumb_size = 'our_thinking_icon';
			$our_thinking_section_icon = get_field('our_thinking_section_icon');
			if( $our_thinking_section_icon ){
				$thumb_url = $our_thinking_section_icon['sizes'][$thumb_size];
			}
			...
			<div class="col-md-4 wow <?php echo $fade_class?>" data-wow-duration="1s">
				<div class="our-thinking-item think-blog">
					<div class="our-thinking-icon">
						<img src="<?php echo $thumb_url;?>" width="121" height="125">
					</div>
					...
					<div class="our-thinking-content match-height">
						...
						$our_thinking_section_excerpt = get_field('our_thinking_section_excerpt', $post->ID);
						if( $our_thinking_section_excerpt ){
							echo $our_thinking_section_excerpt;
						}
						?>
					</div>
