							...
							<div class="item wow <?php echo $class;?>" data-wow-duration="1s">
								<div class="text-center">
									<div class="rounded-blog recent-blog">
										...
										<h3 class="case_title"><a class="case_link" href="<?php the_permalink();?>"><?php the_title();?></a></h3>
				...
				<div class="test_slider_navs_wrapper col-sm-12 wow fadeInUp" data-wow-duration="1s">
					<div class="carousel_navbar">
						...
						while ( $the_query->have_posts() ) {
							...
							<div class="item">
								<div class="test_meta">
									<span class="case_btn_txt">Learn more</span>
									<span class="case_title oob_red"><a class="case_link" href="<?php the_permalink();?>"><?php echo get_the_title();?></a></span>
								</div>
							</div>
							<?php
						}
...
jQuery(document).ready(function($) {
	...
	jQuery("#<?php echo $carousel_navbar_id;?>").on("click", ".owl-item", function (e) {
		if( !$(e.target).hasClass('case_link') ){
			e.preventDefault();
