...
function oob_scripts_styles(){
	...
	wp_enqueue_script( 'google_map',   'https://maps.googleapis.com/maps/api/js?key=AIzaSyBob92fPkzMAyZOu1NdGX2ozNEgI1tJWyM', array('jquery'), '', true );
...
function thecorps_mailchimp_signup_action(){
	...
	if ($api->errorCode){
		echo '<div class="has_error">'.$api->errorMessage."</div>";
	} else {
